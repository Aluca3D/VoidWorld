...
class MobLootDrop(private val plugin: JavaPlugin, private val config: MobLootDropConfig) : Listener {
    ...
    fun onMobDeath(event: EntityDeathEvent) {
        ...
        for (dropDefinition in drops) {
            ...
            var amount = dropDefinition.minAmount +
